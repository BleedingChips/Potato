...
export namespace Potato::Document
{
	...
	struct DocumentReader
	{
		...
		std::optional<Encode::EncodeInfo> ReadSome(std::span<char8_t> output, std::size_t max_character_count = std::numeric_limits<std::size_t>::max());
	...
	{
		std::array<char8_t, 2048> tem_buffer;
		while (true)
		{
